...
export default function Signal098() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "098",
    title: "Saudi Arabia AI Entertainment & Gaming Strategic Pivot",
    description: "Saudi Arabia making decisive push into AI-generated entertainment with Luma AI expansion. Strategic pivot toward AI and gaming-led cultural industries with focus on digital infrastructure as economic driver.",

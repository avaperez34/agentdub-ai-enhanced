...
export default function Signal071() {
  const signalUrl = "https://agentdub.ai/signals/071";
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm text-muted-foreground mb-2">SIGNAL #071</p>
              <p className="text-sm text-muted-foreground">Feb 9, 2026</p>
            </div>
            <ShareButton url={signalUrl} title="Deloitte GenAI Adoption Survey Reveals C-Suite Ambition-Execution Gap in GCC" />
          </div>
          ...
          <div className="flex gap-4 mb-8">
            <div className="px-4 py-2 bg-accent/10 rounded-lg">
              <p className="text-sm font-semibold text-accent">Enterprise Adoption</p>
            </div>
            <div className="px-4 py-2 bg-secondary/20 rounded-lg">
              <p className="text-sm">Impact: 7.8/10</p>
            </div>
            <div className="px-4 py-2 bg-secondary/20 rounded-lg">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h2>Key Findings</h2>
          <h3>Ambition vs. Execution Gap</h3>
          <p>
          ...
          <h3>Sector-Specific Variation</h3>
          <p>

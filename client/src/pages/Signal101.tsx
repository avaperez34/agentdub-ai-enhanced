...
export default function Signal101() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "101",
    title: "Saudi Arabia AI Training Hub - Cost-Effective Computing Leadership",
    description: "Saudi Arabia establishing one of world's most cost-effective AI training hubs at 11 cents per million input-output tokens.",

...
export default function Signal099() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "099",
    title: "UAE Open-Source AI Leadership - K2 Think V2 Launch",
    description: "UAE achieving global AI leadership through open-source strategy. MBZUAI and G42 launched K2 Think V2 - transparent, fully open reasoning system outperforming larger proprietary models.",
    country: "UAE",
    date: "2026-02-10",
    impact: 8.5,

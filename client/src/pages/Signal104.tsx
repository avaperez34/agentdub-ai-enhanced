...
export default function Signal104() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "104",
    title: "Saudi Arabia AI-Powered Drone Acquisition - Shield AI Partnership",
    description: "Saudi Arabia in talks with US AI startup Shield AI to purchase AI-powered drones for defense applications.",

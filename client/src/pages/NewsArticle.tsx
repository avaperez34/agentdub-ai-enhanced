...
The Kingdom's combination of capital (Savvy Games Group's $38B), market size (23M gamers), and infrastructure (NEOM, esports venues) positions it to compete with established gaming hubs in Asia, Europe, and North America.
  ...
  "083": {
    id: "083",
    title: "Qatar Ministry Launches AI Agent Factory with Microsoft",
    category: "Government Technology",
    date: "2026-02-08",
    readTime: "6 min",
    isPremium: false,
    content: `Qatar Ministry of Commerce and Industry launched AI Agent Factory platform with Microsoft to develop, manage, and deploy intelligent solutions across government services.`,
  },
  "082": {
    id: "082",
    ...
    readTime: "8 min",
    isPremium: false,
    content: `World Governments Summit in Dubai convened 6,000+ participants including 60+ heads of state. Governments moving beyond AI experimentation to population-scale deployment.`,
  },
  "081": {
    id: "081",
    title: "UAE Cabinet Approves First-of-Its-Kind AI Regulatory Ecosystem",
    category: "Regulation and Compliance",
    date: "2026-02-06",
    readTime: "7 min",
    isPremium: false,
    content: `UAE Cabinet approved innovative AI regulatory ecosystem enabling real-time law impact tracking and accelerating legal reform.`,
  },
  "080": {
    id: "080",
    title: "GCC Tax Leaders Prioritize AI Quality Over Speed - Deloitte Survey",
    category: "Enterprise Adoption",
    date: "2026-02-09",
    readTime: "8 min",
    isPremium: false,
    content: `Deloitte 2026 survey reveals GCC tax and finance leaders prioritizing AI quality over efficiency gains. Data fragmentation emerges as primary adoption bottleneck.`,
  },
  "079": {
    id: "079",
    title: "Saudi Arabia Leads Global Public Sector AI Adoption",
    category: "Public Sector",
    date: "2026-02-05",
    readTime: "7 min",
    isPremium: false,
    content: `New index ranks 10 countries on public sector AI implementation effectiveness, with Saudi Arabia leading globally.`,
  },
  "078": {
    id: "078",
    title: "DEWA Becomes First Global Utility on ChatGPT Platform",
    category: "Public Services",
    date: "2026-02-08",
    readTime: "6 min",
    isPremium: false,
    content: `Dubai Electricity and Water Authority becomes first utility company worldwide to integrate with ChatGPT platform.`,
  },
  "077": {
    id: "077",
    title: "Khalifa University Cybersecurity AI Research Accepted by ICLR 2026",
    category: "Research and Development",
    date: "2026-02-03",
    readTime: "6 min",
    isPremium: false,
    content: `Khalifa University researchers develop RedSage AI model for cybersecurity, with research paper accepted by ICLR 2026.`,
  },
  "076": {
    id: "076",
    title: "G42 Vietnam AI Hub Secures $1B Usage Commitments",
    category: "Global Infrastructure",
    date: "2026-02-09",
    readTime: "7 min",
    isPremium: false,
    content: `G42 secures $1 billion in usage commitments for Vietnam AI hub, one of Southeast Asia largest data centre deployments.`,
  },
  "075": {
    id: "075",
    title: "Qatar Investment Authority Launches $2B Startup Fund with AI Compute Subsidies",
    category: "Venture Capital",
    date: "2026-02-07",
    readTime: "7 min",
    isPremium: false,
    content: `Qatar Investment Authority announces $2 billion new startup fund with subsidized AI computing power access.`,
  },
  "074": {
    id: "074",
    title: "Germany-Qatar Technology Innovation Hub Launches in Doha",
    category: "International Partnership",
    date: "2026-02-04",
    readTime: "6 min",
    isPremium: false,
    content: `Germany and Qatar announce launch of Technology Innovation Hub in Doha to foster collaboration on AI and digital transformation.`,
  },
  "001": {
    id: "001",

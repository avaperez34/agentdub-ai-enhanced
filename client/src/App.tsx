...
import Signal179 from "@/pages/Signal179";
import Signal180 from "@/pages/Signal180";
import Signal181 from "@/pages/Signal181";
import Signal182 from "@/pages/Signal182";
import Signal183 from "@/pages/Signal183";
import Signal184 from "@/pages/Signal184";
import Signal185 from "@/pages/Signal185";
import Signal186 from "@/pages/Signal186";
import Signal187 from "@/pages/Signal187";
import Signal188 from "@/pages/Signal188";
import Signal189 from "@/pages/Signal189";
import Signal190 from "@/pages/Signal190";
import Signal191 from "@/pages/Signal191";
import Signal192 from "@/pages/Signal192";
import Signal193 from "@/pages/Signal193";
import Signal194 from "@/pages/Signal194";
import Signal195 from "@/pages/Signal195";
import Signal196 from "@/pages/Signal196";
import Signal197 from "@/pages/Signal197";
import Signal198 from "@/pages/Signal198";
import Signal199 from "@/pages/Signal199";
import Signal200 from "@/pages/Signal200";
import Signal201 from "@/pages/Signal201";
import Signal202 from "@/pages/Signal202";
import Signal203 from "@/pages/Signal203";
import Signal204 from "@/pages/Signal204";
import Signal205 from "@/pages/Signal205";
import Signal206 from "@/pages/Signal206";
import Signal207 from "@/pages/Signal207";
import Signal208 from "@/pages/Signal208";
import Signal209 from "@/pages/Signal209";
import Signal210 from "@/pages/Signal210";
import Signal211 from "@/pages/Signal211";
import Signal212 from "@/pages/Signal212";
import Signal213 from "@/pages/Signal213";
import Signal214 from "@/pages/Signal214";
import Signal215 from "@/pages/Signal215";
...
import Signal224 from "@/pages/Signal224";
import Signal225 from "@/pages/Signal225";
import Signal226 from "@/pages/Signal226";
import Signal227 from "@/pages/Signal227";
import Signal228 from "@/pages/Signal228";
import Signal229 from "@/pages/Signal229";
import Signal230 from "@/pages/Signal230";
import Signal231 from "@/pages/Signal231";
import Signal232 from "@/pages/Signal232";
import Signal233 from "@/pages/Signal233";
import Signal234 from "@/pages/Signal234";
import Signal235 from "@/pages/Signal235";
import Signal236 from "@/pages/Signal236";
import Signal237 from "@/pages/Signal237";
import Signal238 from "@/pages/Signal238";
...
function Router() {
  ...
  return (
    <>
      ...
      <Route path={"signals/179"} component={Signal179} />
      <Route path={"signals/180"} component={Signal180} />
      <Route path={"signals/181"} component={Signal181} />
      <Route path={"signals/182"} component={Signal182} />
      <Route path={"signals/183"} component={Signal183} />
      <Route path={"signals/184"} component={Signal184} />
      <Route path={"signals/185"} component={Signal185} />
      <Route path={"signals/186"} component={Signal186} />
      <Route path={"signals/187"} component={Signal187} />
      <Route path={"signals/188"} component={Signal188} />
      <Route path={"signals/189"} component={Signal189} />
      <Route path={"signals/190"} component={Signal190} />
      <Route path={"signals/191"} component={Signal191} />
      <Route path={"signals/192"} component={Signal192} />
      <Route path={"signals/193"} component={Signal193} />
      <Route path={"signals/194"} component={Signal194} />
      <Route path={"signals/195"} component={Signal195} />
      <Route path={"signals/196"} component={Signal196} />
      <Route path={"signals/197"} component={Signal197} />
      <Route path={"signals/198"} component={Signal198} />
      <Route path={"signals/199"} component={Signal199} />
      <Route path={"signals/200"} component={Signal200} />
      <Route path={"signals/201"} component={Signal201} />
      <Route path={"signals/202"} component={Signal202} />
      <Route path={"signals/203"} component={Signal203} />
      <Route path={"signals/204"} component={Signal204} />
      <Route path={"signals/205"} component={Signal205} />
      <Route path={"signals/206"} component={Signal206} />
      <Route path={"signals/207"} component={Signal207} />
      <Route path={"signals/208"} component={Signal208} />
      <Route path={"signals/209"} component={Signal209} />
      <Route path={"signals/210"} component={Signal210} />
      <Route path={"signals/211"} component={Signal211} />
      <Route path={"signals/212"} component={Signal212} />
      <Route path={"signals/213"} component={Signal213} />
      <Route path={"signals/214"} component={Signal214} />
      <Route path={"signals/215"} component={Signal215} />
      ...
      <Route path={"signals/224"} component={Signal224} />
      <Route path={"signals/225"} component={Signal225} />
      <Route path={"signals/226"} component={Signal226} />
      <Route path={"signals/227"} component={Signal227} />
      <Route path={"signals/228"} component={Signal228} />
      <Route path={"signals/229"} component={Signal229} />
      <Route path={"signals/230"} component={Signal230} />
      <Route path={"signals/231"} component={Signal231} />
      <Route path={"signals/232"} component={Signal232} />
      <Route path={"signals/233"} component={Signal233} />
      <Route path={"signals/234"} component={Signal234} />
      <Route path={"signals/235"} component={Signal235} />
      <Route path={"signals/236"} component={Signal236} />
      <Route path={"signals/237"} component={Signal237} />
      <Route path={"signals/238"} component={Signal238} />

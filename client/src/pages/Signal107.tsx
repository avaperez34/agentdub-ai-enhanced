...
export default function Signal107() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "107",
    title: "DCO Digital Cooperation - GCC Leadership in Global Digital Governance",
    description: "Digital Co-operation Organisation General Assembly in Kuwait with GCC states leading digital transformation agenda.",

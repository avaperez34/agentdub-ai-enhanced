...
export default function Signal082() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "082",
    title: "Germany-Qatar Technology Innovation Hub Launches in Doha - International AI Collaboration",
    description: "Germany and Qatar announce launch of Technology Innovation Hub in Doha to foster collaboration on AI, advanced manufacturing, and digital transformation. Partnership brings European technical expertise and innovation culture to GCC market. Represents growing international recognition of GCC as AI hub and signals shift toward knowledge-intensive partnerships.",

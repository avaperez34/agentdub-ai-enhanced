...
export default function Signal100() {
  const [copied, setCopied] = useState(false);

  const signal = {
    id: "100",
    title: "Oman AI Implementation - Healthcare, Justice, Education Pilots",
    description: "Oman successfully implementing AI pilot projects across priority sectors moving from experimentation to real-world deployment.",
    country: "Oman",
    date: "2026-02-10",
    impact: 8.5,
